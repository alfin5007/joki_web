<?php
if (!function_exists('_722f12247fdd73c696cb2eb7dd82dfd0')):
function _722f12247fdd73c696cb2eb7dd82dfd0($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php $__attrs89dbfd7da1a7bcc365a666eb0ec68f60 = ['attributes' => $attributes->class($classes),'dataFluxNavlistItem' => true]; ?>
...
<?php _11de2e8348f8dc6c1a8fe8361a7ef2e9($__blaze, ['icon' => $iconTrailing,'variant' => $iconVariant,'class' => 'size-4!'], [], ['icon', 'variant'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
...
<?php $__attrs04c8f5849a455c94494a0538dbf4d686 = ['attributes' => $badgeAttributes]; ?>
...
<?php _89dbfd7da1a7bcc365a666eb0ec68f60($__blaze, $__attrs89dbfd7da1a7bcc365a666eb0ec68f60, $__slots89dbfd7da1a7bcc365a666eb0ec68f60, ['attributes', 'dataFluxNavlistItem'], ['dataFluxNavlistItem' => 'data-flux-navlist-item'], $__this ?? (isset($this) ? $this : null)); ?>
...
} endif; ?><?php /**PATH /home/caplinux/project/joki_web/vendor/livewire/flux/src/../stubs/resources/views/flux/navlist/item.blade.php ENDPATH**/ ?>