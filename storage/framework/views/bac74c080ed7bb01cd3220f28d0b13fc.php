<?php # [BlazeFolded]:{flux::label}:{C:\laragon\www\joki-web\vendor\livewire\flux\src/../stubs/resources/views/flux/label.blade.php}:{1776985208} ?>
<?php # [BlazeFolded]:{flux::description}:{C:\laragon\www\joki-web\vendor\livewire\flux\src/../stubs/resources/views/flux/description.blade.php}:{1776985208} ?>
<?php # [BlazeFolded]:{flux::field}:{C:\laragon\www\joki-web\vendor\livewire\flux\src/../stubs/resources/views/flux/field.blade.php}:{1776985208} ?>
<?php
if (!function_exists('_bac74c080ed7bb01cd3220f28d0b13fc')):
function _bac74c080ed7bb01cd3220f28d0b13fc($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php _2404d00002dd3b730d8d228f7e58b818($__blaze, ['name' => $scope['name']], [], ['name'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
} endif; ?><?php /**PATH C:\laragon\www\joki-web\vendor\livewire\flux\src/../stubs/resources/views/flux/with-inline-field.blade.php ENDPATH**/ ?>