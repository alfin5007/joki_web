<?php # [BlazeFolded]:{flux::icon.chevron-down}:{/home/caplinux/project/joki_web/vendor/livewire/flux/src/../stubs/resources/views/flux/icon/chevron-down.blade.php}:{1776985208} ?>
<?php # [BlazeFolded]:{flux::icon.chevron-right}:{/home/caplinux/project/joki_web/vendor/livewire/flux/src/../stubs/resources/views/flux/icon/chevron-right.blade.php}:{1776985208} ?>
...
<?php # [BlazeFolded]:{flux::icon.chevron-right}:{/home/caplinux/project/joki_web/vendor/livewire/flux/src/../stubs/resources/views/flux/icon/chevron-right.blade.php}:{1776985208} ?>
<?php
if (!function_exists('_8616665d5c4391840d9dc76a92f49bd0')):
function _8616665d5c4391840d9dc76a92f49bd0($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php _11de2e8348f8dc6c1a8fe8361a7ef2e9($__blaze, ['icon' => $icon,'variant' => $iconVariant,'class' => 'size-4'], [], ['icon', 'variant'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php _11de2e8348f8dc6c1a8fe8361a7ef2e9($__blaze, ['icon' => $icon,'variant' => $iconVariant,'class' => 'in-data-flux-menu:text-zinc-400 in-data-flux-menu:dark:text-white/80 in-data-flux-menu:[[data-flux-sidebar-group-dropdown]>button:hover_&]:text-current size-4'], [], ['icon', 'variant'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
                        <?php else: ?>
                            <?php echo e($icon); ?>
                ...
                <div class="hidden in-data-flux-menu:block">
                    <?php $__blaze->ensureRequired('/home/caplinux/project/joki_web/vendor/livewire/flux/src/../stubs/resources/views/flux/icon/chevron-right.blade.php', $__blaze->compiledPath.'/ad20ac5934cba1d9c1dbf4cbe1cbbff3.php'); ?>
...
<?php _ad20ac5934cba1d9c1dbf4cbe1cbbff3($__blaze, ['variant' => $iconVariant,'class' => 'ms-auto size-4 text-zinc-400 [[data-flux-sidebar-group-dropdown]>button:hover_&]:text-current rtl:hidden'], [], ['variant'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                    <?php $__blaze->ensureRequired('/home/caplinux/project/joki_web/vendor/livewire/flux/src/../stubs/resources/views/flux/icon/chevron-left.blade.php', $__blaze->compiledPath.'/8eb5227cd3eed3752363e3c56f955087.php'); ?>
...
<?php _8eb5227cd3eed3752363e3c56f955087($__blaze, ['variant' => $iconVariant,'class' => 'ms-auto size-4 text-zinc-400 [[data-flux-sidebar-group-dropdown]>button:hover_&]:text-current hidden rtl:inline'], [], ['variant'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                </div>
            </button>
...
>
    <?php ob_start(); ?>
                <?php $__blaze->ensureRequired('/home/caplinux/project/joki_web/vendor/livewire/flux/src/../stubs/resources/views/flux/menu/group.blade.php', $__blaze->compiledPath.'/075da5146eb03e00b8b4300ddb167866.php'); ?>
<?php if (isset($__slots075da5146eb03e00b8b4300ddb167866)) { $__slotsStack075da5146eb03e00b8b4300ddb167866[] = $__slots075da5146eb03e00b8b4300ddb167866; } ?>
<?php if (isset($__attrs075da5146eb03e00b8b4300ddb167866)) { $__attrsStack075da5146eb03e00b8b4300ddb167866[] = $__attrs075da5146eb03e00b8b4300ddb167866; } ?>
<?php $__attrs075da5146eb03e00b8b4300ddb167866 = ['heading' => $heading]; ?>
<?php $__slots075da5146eb03e00b8b4300ddb167866 = []; ?>
<?php $__blaze->pushData($__attrs075da5146eb03e00b8b4300ddb167866); ?>
<?php ob_start(); ?>
                    <?php echo e($slot); ?>

                <?php $__slots075da5146eb03e00b8b4300ddb167866['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slots075da5146eb03e00b8b4300ddb167866); ?>
<?php _075da5146eb03e00b8b4300ddb167866($__blaze, $__attrs075da5146eb03e00b8b4300ddb167866, $__slots075da5146eb03e00b8b4300ddb167866, ['heading'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStack075da5146eb03e00b8b4300ddb167866)) { $__slots075da5146eb03e00b8b4300ddb167866 = array_pop($__slotsStack075da5146eb03e00b8b4300ddb167866); } ?>
<?php if (! empty($__attrsStack075da5146eb03e00b8b4300ddb167866)) { $__attrs075da5146eb03e00b8b4300ddb167866 = array_pop($__attrsStack075da5146eb03e00b8b4300ddb167866); } ?>
<?php $__blaze->popData(); ?>
...
} endif; ?><?php /**PATH /home/caplinux/project/joki_web/vendor/livewire/flux/src/../stubs/resources/views/flux/sidebar/group.blade.php ENDPATH**/ ?>