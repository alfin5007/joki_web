<?php
if (!function_exists('__a8ba029a5fcf7ea2efa7c362b16c4a48')):
function __a8ba029a5fcf7ea2efa7c362b16c4a48($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<th <?php echo e($attributes->class($classes)); ?> data-flux-column>
    <?php if ($sortable): ?>
        <div class="flex in-[.group\/center-align]:justify-center in-[.group\/end-align]:justify-end">
            <?php $__blaze->ensureRequired('C:\laragon\www\joki-web\vendor\livewire\flux\src/../stubs/resources/views/flux/table/sortable.blade.php', $__blaze->compiledPath.'/fd3ab540baba7ccace13b8026c725b68.php'); ?>
<?php if (isset($__slotsfd3ab540baba7ccace13b8026c725b68)) { $__slotsStackfd3ab540baba7ccace13b8026c725b68[] = $__slotsfd3ab540baba7ccace13b8026c725b68; } ?>
<?php if (isset($__attrsfd3ab540baba7ccace13b8026c725b68)) { $__attrsStackfd3ab540baba7ccace13b8026c725b68[] = $__attrsfd3ab540baba7ccace13b8026c725b68; } ?>
<?php $__attrsfd3ab540baba7ccace13b8026c725b68 = ['sorted' => $sorted,'direction' => $direction]; ?>
<?php $__slotsfd3ab540baba7ccace13b8026c725b68 = []; ?>
<?php $__blaze->pushData($__attrsfd3ab540baba7ccace13b8026c725b68); ?>
<?php ob_start(); ?>
                <div><?php echo e($slot); ?></div>
            <?php $__slotsfd3ab540baba7ccace13b8026c725b68['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slotsfd3ab540baba7ccace13b8026c725b68); ?>
<?php __fd3ab540baba7ccace13b8026c725b68($__blaze, $__attrsfd3ab540baba7ccace13b8026c725b68, $__slotsfd3ab540baba7ccace13b8026c725b68, ['sorted', 'direction'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStackfd3ab540baba7ccace13b8026c725b68)) { $__slotsfd3ab540baba7ccace13b8026c725b68 = array_pop($__slotsStackfd3ab540baba7ccace13b8026c725b68); } ?>
<?php if (! empty($__attrsStackfd3ab540baba7ccace13b8026c725b68)) { $__attrsfd3ab540baba7ccace13b8026c725b68 = array_pop($__attrsStackfd3ab540baba7ccace13b8026c725b68); } ?>
<?php $__blaze->popData(); ?>
        </div>
    <?php else: ?>
...
} endif; ?><?php /**PATH C:\laragon\www\joki-web\vendor\livewire\flux\src/../stubs/resources/views/flux/table/column.blade.php ENDPATH**/ ?>