<?php
if (!function_exists('__0b92ce5fe8d454ee0ee6ffbcbd18b067')):
function __0b92ce5fe8d454ee0ee6ffbcbd18b067($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php if ($type === 'file'): ?>
    <?php $__blaze->ensureRequired('C:\laragon\www\joki-web\vendor\livewire\flux\src/../stubs/resources/views/flux/with-field.blade.php', $__blaze->compiledPath.'/78e8109092d2a92e0a6929ab7b7f3af2.php'); ?>
<?php if (isset($__slots78e8109092d2a92e0a6929ab7b7f3af2)) { $__slotsStack78e8109092d2a92e0a6929ab7b7f3af2[] = $__slots78e8109092d2a92e0a6929ab7b7f3af2; } ?>
<?php if (isset($__attrs78e8109092d2a92e0a6929ab7b7f3af2)) { $__attrsStack78e8109092d2a92e0a6929ab7b7f3af2[] = $__attrs78e8109092d2a92e0a6929ab7b7f3af2; } ?>
<?php $__attrs78e8109092d2a92e0a6929ab7b7f3af2 = ['attributes' => $attributes,'name' => $name]; ?>
<?php $__slots78e8109092d2a92e0a6929ab7b7f3af2 = []; ?>
<?php $__blaze->pushData($__attrs78e8109092d2a92e0a6929ab7b7f3af2); ?>
<?php ob_start(); ?>
        <?php $__blaze->ensureRequired('C:\laragon\www\joki-web\vendor\livewire\flux\src/../stubs/resources/views/flux/input/file.blade.php', $__blaze->compiledPath.'/9963b539d232f2a1091f6ed665013995.php'); ?>
<?php $__blaze->pushData(['attributes' => $attributes,'name' => $name,'size' => $size]); ?>
<?php __9963b539d232f2a1091f6ed665013995($__blaze, ['attributes' => $attributes,'name' => $name,'size' => $size], [], ['attributes', 'name', 'size'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
    <?php $__slots78e8109092d2a92e0a6929ab7b7f3af2['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slots78e8109092d2a92e0a6929ab7b7f3af2); ?>
<?php __78e8109092d2a92e0a6929ab7b7f3af2($__blaze, $__attrs78e8109092d2a92e0a6929ab7b7f3af2, $__slots78e8109092d2a92e0a6929ab7b7f3af2, ['attributes', 'name'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStack78e8109092d2a92e0a6929ab7b7f3af2)) { $__slots78e8109092d2a92e0a6929ab7b7f3af2 = array_pop($__slotsStack78e8109092d2a92e0a6929ab7b7f3af2); } ?>
<?php if (! empty($__attrsStack78e8109092d2a92e0a6929ab7b7f3af2)) { $__attrs78e8109092d2a92e0a6929ab7b7f3af2 = array_pop($__attrsStack78e8109092d2a92e0a6929ab7b7f3af2); } ?>
<?php $__blaze->popData(); ?>
        ...
        <div <?php echo e($attributes->only('class')->class('w-full relative block group/input')); ?> data-flux-input>
            <?php if (is_string($iconLeading)): ?>
                <div class="pointer-events-none absolute top-0 bottom-0 border-s border-transparent flex items-center justify-center text-xs text-zinc-400/75 dark:text-white/60 ps-3 start-0">
                    <?php $__blaze->ensureRequired('C:\laragon\www\joki-web\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/index.blade.php', $__blaze->compiledPath.'/53edb446ac6be75546af2e08fbe45102.php'); ?>
<?php $__blaze->pushData(['icon' => $iconLeading,'variant' => $iconVariant,'class' => $iconClasses]); ?>
<?php __53edb446ac6be75546af2e08fbe45102($__blaze, ['icon' => $iconLeading,'variant' => $iconVariant,'class' => $iconClasses], [], ['icon', 'variant', 'class'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                </div>
            ...
            <input
                ...
                [STARTCOMPILEDUNBLAZE:7P9fHRq3nu]<?php \Livewire\Blaze\Unblaze::storeScope("7P9fHRq3nu", scope: ['name' => $name ?? null, 'invalid' => $invalid ?? false]) ?>[ENDCOMPILEDUNBLAZE:7P9fHRq3nu]
                data-flux-control
...
<?php __53edb446ac6be75546af2e08fbe45102($__blaze, ['name' => 'loading','variant' => $iconVariant,'class' => $iconClasses,'wire:loading' => true,'wire:target' => $wireTarget], [], ['variant', 'class', 'wire:loading', 'wire:target'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                    <?php endif; ?>

                    <?php if ($clearable): ?>
                        <?php $__blaze->ensureRequired('C:\laragon\www\joki-web\vendor\livewire\flux\src/../stubs/resources/views/flux/input/clearable.blade.php', $__blaze->compiledPath.'/d3c851962a6ec508d746254b04ceddc4.php'); ?>
<?php $__blaze->pushData(['inset' => 'left right','size' => $size,'iconVariant' => $iconVariant]); ?>
<?php __d3c851962a6ec508d746254b04ceddc4($__blaze, ['inset' => 'left right','size' => $size,'iconVariant' => $iconVariant], [], ['size', 'iconVariant'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                    <?php endif; ?>
                    ...
                    <?php if ($expandable): ?>
                        <?php $__blaze->ensureRequired('C:\laragon\www\joki-web\vendor\livewire\flux\src/../stubs/resources/views/flux/input/expandable.blade.php', $__blaze->compiledPath.'/bda094d61e464a7bacd7ed3bd7c858fc.php'); ?>
<?php $__blaze->pushData(['inset' => 'left right','size' => $size,'iconVariant' => $iconVariant]); ?>
<?php __bda094d61e464a7bacd7ed3bd7c858fc($__blaze, ['inset' => 'left right','size' => $size,'iconVariant' => $iconVariant], [], ['size', 'iconVariant'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                    <?php endif; ?>

                    <?php if ($copyable): ?>
                        <?php $__blaze->ensureRequired('C:\laragon\www\joki-web\vendor\livewire\flux\src/../stubs/resources/views/flux/input/copyable.blade.php', $__blaze->compiledPath.'/0d7c140b8c0c048aef8dc08dd7e0a5c8.php'); ?>
<?php $__blaze->pushData(['inset' => 'left right','size' => $size,'iconVariant' => $iconVariant]); ?>
<?php __0d7c140b8c0c048aef8dc08dd7e0a5c8($__blaze, ['inset' => 'left right','size' => $size,'iconVariant' => $iconVariant], [], ['size', 'iconVariant'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                    <?php endif; ?>

                    <?php if ($viewable): ?>
                        <?php $__blaze->ensureRequired('C:\laragon\www\joki-web\vendor\livewire\flux\src/../stubs/resources/views/flux/input/viewable.blade.php', $__blaze->compiledPath.'/3d140a2798f32cbc8ad40430773db770.php'); ?>
<?php $__blaze->pushData(['inset' => 'left right','size' => $size,'iconVariant' => $iconVariant]); ?>
<?php __3d140a2798f32cbc8ad40430773db770($__blaze, ['inset' => 'left right','size' => $size,'iconVariant' => $iconVariant], [], ['size', 'iconVariant'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                    <?php endif; ?>
...
<?php __53edb446ac6be75546af2e08fbe45102($__blaze, ['icon' => $iconTrailing,'variant' => $iconVariant,'class' => $trailingIconClasses], [], ['icon', 'variant', 'class'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php __53edb446ac6be75546af2e08fbe45102($__blaze, ['icon' => $iconTrailing,'variant' => $iconVariant,'class' => $iconClasses], [], ['icon', 'variant', 'class'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
            </div>
        <?php elseif  ($iconTrailing): ?>
...
} endif; ?><?php /**PATH C:\laragon\www\joki-web\vendor\livewire\flux\src/../stubs/resources/views/flux/input/index.blade.php ENDPATH**/ ?>