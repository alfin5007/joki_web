<?php
if (!function_exists('__12ab0c3219ff0975cbf1dc8ea8fca0e7')):
function __12ab0c3219ff0975cbf1dc8ea8fca0e7($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php ob_start(); ?>
    ...
    <?php $__slotse6b1fd8f6cbcb18397279128f52ec874['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slotse6b1fd8f6cbcb18397279128f52ec874); ?>
<?php __e6b1fd8f6cbcb18397279128f52ec874($__blaze, $__attrse6b1fd8f6cbcb18397279128f52ec874, $__slotse6b1fd8f6cbcb18397279128f52ec874, ['content', 'position', 'kbd'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
} endif; ?><?php /**PATH /home/caplinux/project/joki_web/vendor/livewire/flux/src/../stubs/resources/views/flux/sidebar/collapse.blade.php ENDPATH**/ ?>