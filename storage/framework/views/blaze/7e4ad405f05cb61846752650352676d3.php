<?php
if (!function_exists('__7e4ad405f05cb61846752650352676d3')):
function __7e4ad405f05cb61846752650352676d3($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($collapsibleOnMobile): ?>
    <?php $__blaze->ensureRequired('/home/caplinux/project/joki_web/vendor/livewire/flux/src/../stubs/resources/views/flux/sidebar/backdrop.blade.php', $__blaze->compiledPath.'/aff4768e2b9055f6038675faea993a28.php'); ?>
<?php $__blaze->pushData([]); ?>
<?php __aff4768e2b9055f6038675faea993a28($__blaze, [], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
} endif; ?><?php /**PATH /home/caplinux/project/joki_web/vendor/livewire/flux/src/../stubs/resources/views/flux/sidebar/index.blade.php ENDPATH**/ ?>