<?php
if (!function_exists('__1a31845fba330f55099c635943525426')):
function __1a31845fba330f55099c635943525426($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php $__blaze->ensureRequired('C:\laragon\www\joki-web\vendor\livewire\flux\src/../stubs/resources/views/flux/button-or-div.blade.php', $__blaze->compiledPath.'/a0272af298ddbb7527f9f2de5d217a2e.php'); ?>
<?php if (isset($__slotsa0272af298ddbb7527f9f2de5d217a2e)) { $__slotsStacka0272af298ddbb7527f9f2de5d217a2e[] = $__slotsa0272af298ddbb7527f9f2de5d217a2e; } ?>
<?php if (isset($__attrsa0272af298ddbb7527f9f2de5d217a2e)) { $__attrsStacka0272af298ddbb7527f9f2de5d217a2e[] = $__attrsa0272af298ddbb7527f9f2de5d217a2e; } ?>
<?php $__attrsa0272af298ddbb7527f9f2de5d217a2e = ['attributes' => $attributes->class($classes),'dataFluxBadge' => true]; ?>
<?php $__slotsa0272af298ddbb7527f9f2de5d217a2e = []; ?>
<?php $__blaze->pushData($__attrsa0272af298ddbb7527f9f2de5d217a2e); ?>
<?php ob_start(); ?>
...
<?php __53edb446ac6be75546af2e08fbe45102($__blaze, ['icon' => $icon,'variant' => $iconVariant,'class' => $iconClasses,'dataFluxBadgeIcon' => true], [], ['icon', 'variant', 'class', 'dataFluxBadgeIcon'], ['dataFluxBadgeIcon' => 'data-flux-badge-icon'], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
    <?php else: ?>
        <?php echo e($icon); ?>
...
<?php $__blaze->popData(); ?>
    ...
    <?php endif; ?>
<?php $__slotsa0272af298ddbb7527f9f2de5d217a2e['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slotsa0272af298ddbb7527f9f2de5d217a2e); ?>
<?php __a0272af298ddbb7527f9f2de5d217a2e($__blaze, $__attrsa0272af298ddbb7527f9f2de5d217a2e, $__slotsa0272af298ddbb7527f9f2de5d217a2e, ['attributes', 'dataFluxBadge'], ['dataFluxBadge' => 'data-flux-badge'], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStacka0272af298ddbb7527f9f2de5d217a2e)) { $__slotsa0272af298ddbb7527f9f2de5d217a2e = array_pop($__slotsStacka0272af298ddbb7527f9f2de5d217a2e); } ?>
<?php if (! empty($__attrsStacka0272af298ddbb7527f9f2de5d217a2e)) { $__attrsa0272af298ddbb7527f9f2de5d217a2e = array_pop($__attrsStacka0272af298ddbb7527f9f2de5d217a2e); } ?>
<?php $__blaze->popData(); ?>
<?php
echo $__blaze->processPassthroughContent('ltrim', ltrim(ob_get_clean()));
} endif; ?><?php /**PATH C:\laragon\www\joki-web\vendor\livewire\flux\src/../stubs/resources/views/flux/badge/index.blade.php ENDPATH**/ ?>