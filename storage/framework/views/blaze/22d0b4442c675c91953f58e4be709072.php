<?php
if (!function_exists('__22d0b4442c675c91953f58e4be709072')):
function __22d0b4442c675c91953f58e4be709072($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($collapsibleOnMobile): ?>
    <?php $__blaze->ensureRequired('C:\laragon\www\joki-web\vendor\livewire\flux\src/../stubs/resources/views/flux/sidebar/backdrop.blade.php', $__blaze->compiledPath.'/cfb218de7076c19ed2d7ce7991c4a595.php'); ?>
<?php $__blaze->pushData([]); ?>
<?php __cfb218de7076c19ed2d7ce7991c4a595($__blaze, [], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
} endif; ?><?php /**PATH C:\laragon\www\joki-web\vendor\livewire\flux\src/../stubs/resources/views/flux/sidebar/index.blade.php ENDPATH**/ ?>