<?php
if (!function_exists('__337fd5d83c9689ba9fa73b59c4a7e22e')):
function __337fd5d83c9689ba9fa73b59c4a7e22e($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<div class="<?php echo e($containerClasses); ?>">
    ...
    <?php if ($paginate): ?>
        ...
        <?php $__blaze->ensureRequired('C:\laragon\www\joki-web\vendor\livewire\flux\src/../stubs/resources/views/flux/pagination.blade.php', $__blaze->compiledPath.'/d9392e8ca6bb584053c178a4d2206f8a.php'); ?>
<?php $__blaze->pushData(['attributes' => $paginationAttributes]); ?>
<?php __d9392e8ca6bb584053c178a4d2206f8a($__blaze, ['attributes' => $paginationAttributes], [], ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
    <?php endif; ?>
</div>
<?php
echo $__blaze->processPassthroughContent('ltrim', ltrim(ob_get_clean()));
} endif; ?><?php /**PATH C:\laragon\www\joki-web\vendor\livewire\flux\src/../stubs/resources/views/flux/table/index.blade.php ENDPATH**/ ?>