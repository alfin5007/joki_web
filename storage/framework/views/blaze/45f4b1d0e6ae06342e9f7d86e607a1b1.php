<?php
if (!function_exists('__45f4b1d0e6ae06342e9f7d86e607a1b1')):
function __45f4b1d0e6ae06342e9f7d86e607a1b1($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php ob_start(); ?>
    ...
    <?php $__slots22edaf4a6ce1a850b5ec89e869d9aa77['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slots22edaf4a6ce1a850b5ec89e869d9aa77); ?>
<?php __22edaf4a6ce1a850b5ec89e869d9aa77($__blaze, $__attrs22edaf4a6ce1a850b5ec89e869d9aa77, $__slots22edaf4a6ce1a850b5ec89e869d9aa77, ['content', 'position', 'kbd'], [], $__this ?? (isset($this) ? $this : null)); ?>
