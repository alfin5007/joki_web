...
<?php ob_start(); ?><ui-dropdown position="bottom start"  data-flux-dropdown>
    <?php ob_start(); ?>
    <?php $__blaze->ensureRequired('/home/caplinux/project/joki_web/vendor/livewire/flux/src/../stubs/resources/views/flux/sidebar/profile.blade.php', $__blaze->compiledPath.'/46150b521746b3acf90468bc7f9f9deb.php'); ?>
...
<?php _46150b521746b3acf90468bc7f9f9deb($__blaze, ['name' => auth()->user()->name,'initials' => auth()->user()->initials(),'icon:trailing' => 'chevrons-up-down','dataTest' => 'sidebar-menu-button'], [], ['name', 'initials'], ['dataTest' => 'data-test'], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
<?php /**PATH /home/caplinux/project/joki_web/resources/views/components/desktop-user-menu.blade.php ENDPATH**/ ?>