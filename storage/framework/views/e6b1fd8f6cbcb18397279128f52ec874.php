<?php
if (!function_exists('_e6b1fd8f6cbcb18397279128f52ec874')):
function _e6b1fd8f6cbcb18397279128f52ec874($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php ob_start(); ?><?php echo e($content); ?><?php $__slotsd496b9a6d67da283e2c0f4f95e174d25['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
