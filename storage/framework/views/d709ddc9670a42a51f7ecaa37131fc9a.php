<?php # [BlazeFolded]:{flux::link}:{C:\laragon\www\joki-web\vendor\livewire\flux\src/../stubs/resources/views/flux/link.blade.php}:{1776985208} ?>
...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('login.store')); ?>" class="flex flex-col gap-6">
            ...
            <!-- Email Address -->
            <?php $__blaze->ensureRequired('C:\laragon\www\joki-web\vendor\livewire\flux\src/../stubs/resources/views/flux/input/index.blade.php', $__blaze->compiledPath.'/0b92ce5fe8d454ee0ee6ffbcbd18b067.php'); ?>
...
<?php _0b92ce5fe8d454ee0ee6ffbcbd18b067($__blaze, ['name' => 'email','label' => __('Email address'),'value' => old('email'),'type' => 'email','required' => true,'autofocus' => true,'autocomplete' => 'email','placeholder' => 'email@example.com'], [], ['label', 'value', 'required', 'autofocus'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php _0b92ce5fe8d454ee0ee6ffbcbd18b067($__blaze, ['name' => 'password','label' => __('Password'),'type' => 'password','required' => true,'autocomplete' => 'current-password','placeholder' => __('Password'),'viewable' => true], [], ['label', 'required', 'placeholder', 'viewable'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
            ...
            <!-- Remember Me -->
            <?php $__blaze->ensureRequired('C:\laragon\www\joki-web\vendor\livewire\flux\src/../stubs/resources/views/flux/checkbox/index.blade.php', $__blaze->compiledPath.'/612da5b923844ed8e0963967fe51a61d.php'); ?>
<?php $__blaze->pushData(['name' => 'remember','label' => __('Remember me'),'checked' => old('remember')]); ?>
<?php _612da5b923844ed8e0963967fe51a61d($__blaze, ['name' => 'remember','label' => __('Remember me'),'checked' => old('remember')], [], ['label', 'checked'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\joki-web\resources\views/pages/auth/login.blade.php ENDPATH**/ ?>