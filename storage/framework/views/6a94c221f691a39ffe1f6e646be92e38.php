...
<?php # [BlazeFolded]:{flux::icon.briefcase}:{/home/caplinux/project/joki_web/vendor/livewire/flux/src/../stubs/resources/views/flux/icon/briefcase.blade.php}:{1776985208} ?>
<?php # [BlazeFolded]:{flux::table.cell}:{/home/caplinux/project/joki_web/vendor/livewire/flux/src/../stubs/resources/views/flux/table/cell.blade.php}:{1776985208} ?>
<?php # [BlazeFolded]:{flux::table.cell}:{/home/caplinux/project/joki_web/vendor/livewire/flux/src/../stubs/resources/views/flux/table/cell.blade.php}:{1776985208} ?>
<?php # [BlazeFolded]:{flux::badge}:{/home/caplinux/project/joki_web/vendor/livewire/flux/src/../stubs/resources/views/flux/badge/index.blade.php}:{1776985208} ?>
<?php # [BlazeFolded]:{flux::table.cell}:{/home/caplinux/project/joki_web/vendor/livewire/flux/src/../stubs/resources/views/flux/table/cell.blade.php}:{1776985208} ?>
...
<?php echo ltrim(ob_get_clean()); ?>
            ...
            <div class="grid grid-cols-2 gap-3 lg:col-span-3">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php ob_start(); ?><div class="[:where(&amp;)]:bg-white dark:[:where(&amp;)]:bg-white/10 border border-zinc-200 dark:border-white/10 [:where(&amp;)]:p-6 [:where(&amp;)]:rounded-xl group relative overflow-hidden p-3 transition-shadow duration-300 hover:shadow-md" data-flux-card>
    <?php ob_start(); ?>
                        
                        <div class="absolute inset-x-0 top-0 h-[3px] bg-gradient-to-r <?php echo e($stat['gradient']); ?> rounded-t-xl">
                        </div>
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <tr >
        <?php ob_start(); ?>
            ...
            <div class="flex in-[.group\/center-align]:justify-center in-[.group\/end-align]:justify-end"><?php ob_start(); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
        ...
        <?php ob_start(); ?><?php echo e($user->role); ?><?php echo trim(ob_get_clean()); ?>
