<?php # [BlazeFolded]:{flux::label}:{/home/caplinux/project/joki_web/vendor/livewire/flux/src/../stubs/resources/views/flux/label.blade.php}:{1776985208} ?>
<?php # [BlazeFolded]:{flux::description}:{/home/caplinux/project/joki_web/vendor/livewire/flux/src/../stubs/resources/views/flux/description.blade.php}:{1776985208} ?>
<?php # [BlazeFolded]:{flux::field}:{/home/caplinux/project/joki_web/vendor/livewire/flux/src/../stubs/resources/views/flux/field.blade.php}:{1776985208} ?>
<?php
if (!function_exists('_08bf2de01aa8509ae892138f874aebf9')):
function _08bf2de01aa8509ae892138f874aebf9($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php _89e3d77fd3f13e34c0b0d85b0a3c4d83($__blaze, ['name' => $scope['name']], [], ['name'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
} endif; ?><?php /**PATH /home/caplinux/project/joki_web/vendor/livewire/flux/src/../stubs/resources/views/flux/with-inline-field.blade.php ENDPATH**/ ?>